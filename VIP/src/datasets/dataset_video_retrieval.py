...
from datasets.data_utils import mask_batch_text_tokens, img_collate
from datasets.dataloader import init_transform_dict, init_transform_dict_simple
import decord
...
from datasets.sample_frames import SampleFrames
...
class HDVILAVideoRetrievalDataset(Dataset):
    ...
    def id2path(self, id):
        ...
        if self.vis_format == 'video':
            name = os.path.join(self.vis_dir, clip_name.split('/')[-1]+".avi")  #change this
